      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white dark:bg-surface-dark border border-gray-100 dark:border-white/10 rounded-3xl p-8">
            <h2 className="text-xl font-bold mb-2">Real Estate &amp; Landlords</h2>
          ...
          <div className="bg-white dark:bg-surface-dark border border-gray-100 dark:border-white/10 rounded-3xl p-8">
            <h2 className="text-xl font-bold mb-2">Corporate &amp; Institutions</h2>
            <p className="text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-surface-dark border border-gray-100 dark:border-white/10 rounded-3xl p-8">
            <h2 className="text-xl font-bold mb-2">Operators &amp; Franchisees</h2>
            <p className="text-sm text-gray-600 dark:text-gray-300">
        ...
        <section className="bg-white dark:bg-surface-dark border border-gray-100 dark:border-white/10 rounded-3xl p-10 md:p-12 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="flex flex-col gap-1">
              ...
              <input
                className="rounded-xl border border-gray-200 dark:border-white/10 bg-transparent px-3 py-2 outline-none focus:ring-2 focus:ring-primary/40"
            ...
            <div className="flex flex-col gap-1 md:col-span-2">
              ...
              <textarea
                className="rounded-xl border border-gray-200 dark:border-white/10 bg-transparent px-3 py-2 h-28 outline-none focus:ring-2 focus:ring-primary/40 resize-none"
        ...
        <section className="bg-bg-dark text-white rounded-3xl p-8 md:p-10 text-center">
