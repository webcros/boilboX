...
export default function ClientAdmin() {
  ...
  return (
    <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {menuItems.length > 0 ? (
                menuItems.map((meal) => (
                  <div
                    key={meal.id}
                    className="bg-white dark:bg-surface-dark rounded-[2.5rem] overflow-hidden border border-gray-100 dark:border-white/10 hover:shadow-2xl transition-all group"
                  >
                ...
                <div className="col-span-full text-center py-12">
                  <p className="text-gray-500 text-lg">
                    No menu items found. Add dishes using the form.
                  </p>
                  <button
                    onClick={() => setShowDishForm(true)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-surface-dark rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                ...
                <p className="text-gray-500 mb-6">
                  Manage your menu items, categories, and descriptions.
                </p>
                <a
                  href="/studio"
                  target="_blank"
              ...
              <div className="bg-white dark:bg-surface-dark rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                ...
                <p className="text-gray-500 mb-6">
                  Create and manage blog posts, stories, and impact reports.
                </p>
                <a
                  href="/studio"
                  target="_blank"
              ...
              <div className="bg-white dark:bg-surface-dark rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                ...
                <p className="text-gray-500 mb-6">
                  Manage location information and kiosk details.
                </p>
                <a
                  href="/studio"
                  target="_blank"
              ...
              <div className="bg-white dark:bg-surface-dark rounded-2xl p-8 border border-gray-100 dark:border-white/10">
                ...
                <p className="text-gray-500 mb-6">
                  Manage team members, partners, and testimonials.
                </p>
                <a
                  href="/studio"
                  target="_blank"
      ...
      {/* Dish Form Modal */}
      {showDishForm && (
        <DishForm onClose={() => setShowDishForm(false)} onSuccess={handleDishCreated} />
      )}
    </div>
  );
}
